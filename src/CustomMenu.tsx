...
export const CustomMenu = () => (
  <Menu>
    ...
    />
    <Menu.Item
      to="/breedpride_collection_type"
      primaryText="Breedpride Collection Types"
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item
      to="/breed_pride_licence_manager_manage_type"
      primaryText="Breed Pride Licence Manager Manage Types"
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item
      to="/breed_pride_licence_manager_status"
      primaryText="Breed Pride Licence Manager Statuses"
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item
      to="/breed_pride_licence_manager_type"
    ...
    <Menu.Item
      ...
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item to="/letter" primaryText="Letters" leftIcon={<CategoryIcon />} />
    <Menu.Item
      to="/litter_status"
    ...
    />
    <Menu.Item
      to="/operator_routing_rules"
      primaryText="Operator Routing Rules"
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item
      to="/opp_contact_influence"
      primaryText="Opp Contact Influences"
      leftIcon={<PeopleIcon />}
    />
    <Menu.Item
    ...
    <Menu.Item
      ...
      leftIcon={<AccountBalanceWalletIcon />}
    />
    <Menu.Item to="/period" primaryText="Periods" leftIcon={<CategoryIcon />} />
    <Menu.Item
    ...
    <Menu.Item
      ...
      leftIcon={<CategoryIcon />}
    />
    <Menu.Item to="/pet_size" primaryText="Pet Sizes" leftIcon={<PetsIcon />} />
    <Menu.Item
      to="/pet_status"
