...
export default function App() {
  return (
    <Admin dataProvider={dataProvider} layout={CustomLayout}>
      ...
      <Resource
        name="contact_career"
        show={ContactCareerShow}
        create={ContactCareerCreate}
        edit={ContactCareerEdit}
      />
      ...
      <Resource
        name="contact_rating"
        show={ContactRatingShow}
        create={ContactRatingCreate}
        edit={ContactRatingEdit}
      />
